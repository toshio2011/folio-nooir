...
void CrossPointState::toJson(JsonDocument& doc) const {
  ...
  doc["favoriteSleepImageBmpPath"] = favoriteSleepImageBmpPath;
  doc["legacySleepImageDisabled"] = legacySleepImageDisabled;
...
bool CrossPointState::fromJson(JsonVariantConst doc) {
  ...
  favoriteSleepImageBmpPath = doc["favoriteSleepImageBmpPath"] | "";
  legacySleepImageDisabled = doc["legacySleepImageDisabled"] | false;
